              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: CheckboxListTile(
                    title: const Text('Vegetable Burger',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Vegetable cheese Burger',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Vegetable Grilled Burger',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
                    subtitle: const Text('Rs 50'),
                    autofocus: false,
                    activeColor: Colors.white,
                    checkColor: Colors.blue,
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Cheese Grilled Burger',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
