...
class cleanlinessPage extends StatelessWidget {
  const cleanlinessPage({Key? key}) : super(key: key);
                  ...
                  child: Stack(
                    ...
                    children: [
                      Ink.image(
                        ...
                        child: InkWell(onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>com_mail()));
                  ...
                  child: Stack(
                    ...
                    children: [
                      Ink.image(
                        ...
                        child: InkWell(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>com_message()));
                            }
                        ),
                        fit: BoxFit.cover,
                      ),
