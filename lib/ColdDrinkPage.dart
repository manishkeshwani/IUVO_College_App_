              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: CheckboxListTile(
                    title: const Text('Oreo Shake',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Chocolate Shake',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
                    subtitle: const Text('Rs 50'),
                    autofocus: false,
                    activeColor: Colors.white,
                    checkColor: Colors.blue,
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Vanilla Shake',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
                    subtitle: const Text('Rs 50'),
                    autofocus: false,
                    activeColor: Colors.white,
                    checkColor: Colors.blue,
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Butterscotch',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
                    subtitle: const Text('Rs 50'),
                    autofocus: false,
                    activeColor: Colors.white,
                    checkColor: Colors.blue,
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Colors.white),
                      ...
                      borderRadius: BorderRadius.circular(20.0)),
                  child: CheckboxListTile(
                    title: const Text('Strawberry Shake',style: TextStyle(fontSize: 20,fontFamily: 'Pacifico'),),
                    subtitle: const Text('Rs 50'),
                    autofocus: false,
                    activeColor: Colors.white,
                    checkColor: Colors.blue,
